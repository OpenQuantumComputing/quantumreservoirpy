...
def main(num_qubits, num_meas, num_reservoirs, method, noise, lentrain, decode, casename, order, timeplex=10, degree=None):
...
if __name__ == "__main__":
    ...
    print("Running:", num_qubits, num_meas, num_reservoirs, method, noise, lentrain, decode, casename, order)
    main(num_qubits, num_meas, num_reservoirs, method, noise, lentrain, decode, casename, order)
