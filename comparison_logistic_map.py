...
def main(num_qubits, num_meas, num_reservoirs, method, noise, timeplex=10, degree=None):
    ...
    string_identifier="num_qubits"+str(num_qubits)+"_num_meas"+str(num_meas)
...
# Add depolarizing error to all single qubit u1, u2, u3 gates
    ...
    if method == "classical":
        ...
        res = PartialMeasurement(num_qubits, num_meas, backend = AerSimulator(noise_model=noise_model),\
                                 degree=degree, num_reservoirs=num_reservoirs, isingparams=isingparams)
...
if __name__ == "__main__":
    ...
    print("Running:", num_qubits, num_meas, num_reservoirs, method, noise)
    main(num_qubits, num_meas, num_reservoirs, method, noise)
